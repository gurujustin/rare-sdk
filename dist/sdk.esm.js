...
(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 1] = "MAINNET"; // ROPSTEN = 3,
  // RINKEBY = 4,
  // GÖRLI = 5,
  // KOVAN = 42,
...
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.MAINNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.BSCNET] = '0x182b4f445fc8B9304422164ed6417b1bCd1685A5', _FACTORY_ADDRESS_MAP);
var INIT_CODE_HASH = '0x00e0302f607cfb8dc4a8f86d6824aba4dce40e6e9ec96315bee5b786f7553438';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.MAINNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.BSCNET] = '0x1c3da50d5633586187ea852834378b05dbffd798a4b93cb4729f2ac8a4771922', _INIT_CODE_HASH_MAP);
...
Currency.ETHERs = (_Currency$ETHERs = {}, _Currency$ETHERs[ChainId.MAINNET] = Currency.ETHER, _Currency$ETHERs[ChainId.BSCNET] = Currency.BNB, _Currency$ETHERs);
var ETHER = Currency.ETHER;
var BNB = Currency.BNB;
var ETHERs = Currency.ETHERs;
...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', 18, 'WETH', 'Wrapped ETH', 'https://weth.io/'), _WETH[ChainId.BSCNET] = /*#__PURE__*/new Token(ChainId.BSCNET, '0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c', 18, 'WBNB', 'Wrapped BNB', 'https://www.binance.org'), _WETH);
...
export { BNB, ChainId, Currency, CurrencyAmount, ETHER, ETHERs, FACTORY_ADDRESS, FACTORY_ADDRESS_MAP, Fetcher, Fraction, INIT_CODE_HASH, INIT_CODE_HASH_MAP, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
